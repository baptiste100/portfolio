...
const Home = () => {
    return (
        <div className="flex flex-col items-center justify-center px-[25%] gap-15">
            ...
            <NavLink className="bg-stone-900 text-2xl p-5 rounded-2xl font-bold" to="/projects" end> Voir mes projets </NavLink>
        </div>
    )
}
