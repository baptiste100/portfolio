...
export default function Project({ title, description, technos, github } : ProjectData) {
    return (
        <div className="relative bg-stone-900 shadow-lg rounded-xl p-6 hover:shadow-2xl transition duration-300 ease-in-out">
            ...
            { github && <a className="group absolute bottom-5 right-5 flex flex-row border p-2 rounded-lg gap-1 hover:bg-white hover:text-black" href={github} target="_blank">
                <p>🠒</p>
